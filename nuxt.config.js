...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      {
        name: "og:image",
        content: "https://cdn.bitwave.tv/static/img/Bitwave_Banner.jpg",
        hid: "og:image",
      },
    ],
    link: [
      ...
      {
        rel: "stylesheet",
        href: "/assets/Modernize/css/plugins/owl-carousel.css",
      },
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "/assets/Modernize/js/extra-libs/jsgrid/jsgrid.min.css",
      },
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "/assets/Modernize/js/extra-libs/jsgrid/jsgrid-theme.min.css",
      },
      {
        rel: "stylesheet",
        href: "/assets/Modernize/js/extra-libs/jsgrid/jsgrid.css",
  ...
  router: {
    extendRoutes(routes, resolve) {
      routes.push({
        name: "booking-id___en",
        path: "/booking/:id",
        component: resolve(__dirname, "pages/booking/_id.vue"),
      });
    },
  ...
  axios: {
    baseURL: process.env.API_URL, // Use the environment variable
    credentials: false,
    proxy: true, // Can be also an object with default options
  },
  proxy: {
    "/api/": {
      target: "http://143.198.103.113:8086",
      pathRewrite: { "^/service/": "" },
      changeOrigin: true,
    },
    "/base/": {
    ...
    strategies: {
      local: {
        ...
        endpoints: {
          ...
          refresh: {
            url: "/branch/api/master-admins/refresh/?format=web",
            method: "post",
          },
          user: false,
